...
export const seoConfig: Record<string, SEOPageConfig> = {
  ...
  communityCleaning: {
    title: 'Limpieza de Comunidades en Sabadell y Vallès Occidental | Superclim',
    description: 'Limpieza profesional de comunidades, portales, escaleras, ascensores, garajes y zonas comunes en Sabadell, Terrassa y Vallès Occidental. Presupuesto personalizado.',
    canonical: `${baseUrl}/limpieza-de-comunidades`,
    ogTitle: 'Limpieza de Comunidades en el Vallès | Superclim',
    ogDescription: 'Mantenimiento de portales, escaleras, rellanos, ascensores, garajes y zonas comunes para comunidades de vecinos del Vallès.',
    ogImage: defaultOgImage,
    ogType: 'website',
  },
  communityCleaningSabadell: {
    title: 'Limpieza de Comunidades en Sabadell | Escaleras y Portales',
    description: 'Limpieza de comunidades en Sabadell: portales, escaleras, rellanos, ascensores, garajes y zonas comunes. Servicio periódico o puntual con presupuesto personalizado.',
    canonical: `${baseUrl}/limpieza-de-comunidades/sabadell`,
    h1: 'Limpieza de comunidades en Sabadell',
    ogTitle: 'Limpieza de Comunidades en Sabadell | Superclim',
    ogImage: defaultOgImage,
    ogType: 'website',
  },
  communityCleaningTerrassa: {
    title: 'Limpieza de Comunidades en Terrassa | Portales y Escaleras',
    description: 'Servicio de limpieza de comunidades en Terrassa para portales, escaleras, ascensores, garajes y zonas comunes. Presupuesto adaptado a cada finca.',
    canonical: `${baseUrl}/limpieza-de-comunidades/terrassa`,
    h1: 'Limpieza de comunidades en Terrassa',
    ogTitle: 'Limpieza de Comunidades en Terrassa | Superclim',
    ogImage: defaultOgImage,
    ogType: 'website',
  },
  communityCleaningSantQuirze: {
    title: 'Limpieza de Comunidades en Sant Quirze del Vallès | Superclim',
    description: 'Limpieza y mantenimiento de comunidades en Sant Quirze del Vallès: portales, escaleras, ascensores, garajes y espacios comunes.',
    canonical: `${baseUrl}/limpieza-de-comunidades/sant-quirze`,
    h1: 'Limpieza de comunidades en Sant Quirze del Vallès',
    ogTitle: 'Limpieza de Comunidades en Sant Quirze | Superclim',
    ogImage: defaultOgImage,
    ogType: 'website',
  },
  communityCleaningSantCugat: {
    title: 'Limpieza de Comunidades en Sant Cugat del Vallès | Superclim',
    description: 'Mantenimiento de comunidades en Sant Cugat del Vallès: portales, escaleras, ascensores y zonas comunes. Plan por accesos y frecuencia, desde Sabadell.',
    canonical: `${baseUrl}/limpieza-de-comunidades/sant-cugat`,
    h1: 'Limpieza de comunidades en Sant Cugat del Vallès',
    ogTitle: 'Limpieza de Comunidades en Sant Cugat del Vallès | Superclim',
    ogImage: `${baseUrl}/images/comunidades/portal-sant-cugat.webp`,
    ogType: 'website',
  },
  communityCleaningCastellar: {
    title: 'Limpieza de Comunidades en Castellar del Vallès | Superclim',
    description: 'Limpieza de comunidades en Castellar del Vallès. Cuidado de portales, escaleras y rellanos, con mantenimiento periódico coordinado desde Sabadell.',
    canonical: `${baseUrl}/limpieza-de-comunidades/castellar-del-valles`,
    h1: 'Limpieza de comunidades en Castellar del Vallès',
    ogTitle: 'Limpieza de Comunidades en Castellar del Vallès | Superclim',
    ogImage: `${baseUrl}/images/comunidades/portal-castellar-del-valles.webp`,
    ogType: 'website',
  },
  communityCleaningBarbera: {
    title: 'Limpieza de Comunidades en Barberà del Vallès | Superclim',
    description: 'Servicio para comunidades de propietarios en Barberà del Vallès: limpieza de portales, ascensores y zonas comunes. Tareas y periodicidad acordadas.',
    canonical: `${baseUrl}/limpieza-de-comunidades/barbera-del-valles`,
    h1: 'Limpieza de comunidades en Barberà del Vallès',
    ogTitle: 'Limpieza de Comunidades en Barberà del Vallès | Superclim',
    ogImage: `${baseUrl}/images/comunidades/portal-barbera-del-valles.webp`,
    ogType: 'website',
  },
